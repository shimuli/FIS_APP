...
//                FETCH_URL="http://fairmontsinternationalschool.co.ke/fairmontsAPI/fetchattendance.php?admission_no="+admission_no+"&date="+date;
                FETCH_URL= BaseUrl.attendance(admission_no,date);
