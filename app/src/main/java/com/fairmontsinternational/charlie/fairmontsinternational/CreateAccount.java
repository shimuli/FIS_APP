...
//                    FETCH_URL="http://fairmontsinternationalschool.co.ke/fairmontsAPI/addpassword.php?phone_no="+phone_no+"&password="+pass;
                    FETCH_URL= BaseUrl.addpassword(phone_no,pass);
                    execute();
                }
            }
        });
